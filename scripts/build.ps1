...
$HistoricalArchives = @(
    ...
    (Join-Path $ReleaseDir "JM-Downloader-v3.0.0-Windows-x64.zip"),
    (Join-Path $ReleaseDir "JM-Downloader-v3.1.0-Windows-x64.zip"),
    (Join-Path $ReleaseDir "JM-Downloader-v3.2.0-Windows-x64.zip"),
    (Join-Path $ReleaseDir "JM-Downloader-v3.2.1-Windows-x64.zip")
)
